...
public class AdminTrustRemoveMethod extends CommandMethod {

    public AdminTrustRemoveMethod(CommandSender sender, String[] args) {
        super(sender, args, "quarters.command.quartersadmin.trust.remove");
    }
